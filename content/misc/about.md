...
In middle school he attended an optional programming course where he learned logic and programming basics, which further
...
He has also drawn on foundational software engineering texts, including [Programming
...
C. Martin (though he approaches its more prescriptive advice critically.), [The Pragmatic Programmer](https://www.amazon.com/Pragmatic-Programmer-journey-mastery-Anniversary/dp/0135957052) by
Andy Hunt and Dave Thomas. These books have shaped his approach to writing clean and maintainable code.
...
as [Nuxt](https://nuxt.com), [Vercel](https://vercel.com) and [Rybbit](https://github.com/rybbit-io/rybbit) :reference-cite{id="5"}.

### Startups and Entrepreneurship

At the age of 15 he began studying about startups and entrepreneurship, and has been involved in the startup ecosystem since then.
Later at the age of 18 an online friend working at [Fillout](https://fillout.com/) (San Francisco, California) offered to recommend him
for a job as a senior software engineer at the company, due to his "high competence".
He got to the last interview stage but ultimately did not get the job.

In January 2026, he got an offer for a part-time job at a startup working on an AI-powered SaaS product for real estate agents.
...
Kupinic is also passionate about personal growth and self-improvement. He values meaningful connections and relationships, and enjoys spending time with
friends.
...
:::
:::reference-item{id="5"}
https://github.com/nuxt/image/pull/2074; https://github.com/rybbit-io/rybbit/issues/180; https://github.com/vercel/examples/pull/1164
:::
:::reference-item{id="6"}
https://df-malerei.at
:::
